...
(function() {
	...
	// Initialize "On Visible" animations.
		onvisible.add('#icons05', { style: 'fade-down', speed: 1000, intensity: 5, threshold: 3, delay: 0, stagger: 750, staggerSelector: ':scope > li', replay: true });
		onvisible.add('#icons02', { style: 'fade-up', speed: 500, intensity: 5, threshold: 3, delay: 0, replay: true });
